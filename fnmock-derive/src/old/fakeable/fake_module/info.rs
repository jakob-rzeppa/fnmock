...
use crate::{
    old::extract::{function::info::FunctionInfo, item_impl::info::ImplItemFnInfo},
    old::fakeable::fn_closure_trait::build_fn_closure_trait,
    old::names::{
...
mod tests {
    ...
    use crate::old::extract::item_impl::extract_item_impl_info;
    use quote::ToTokens;
