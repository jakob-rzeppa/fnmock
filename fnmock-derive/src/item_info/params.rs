...
//!
//! Kind-specific parameter handling (a spy's `extract_param_idents`/`strip_reference`/
//! `build_reference_call_value`) lives in `expansion_info::spy` instead -- see its module doc.
