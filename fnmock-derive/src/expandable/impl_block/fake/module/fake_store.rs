...
mod tests {
    ...
    fn test_non_generic_store() {
        ...
        let expected = quote! {
            thread_local! {
                static MY_METHOD_STORE: ::std::cell::RefCell<::fnmock::fake_store::FakeStore<::std::rc::Rc<dyn Fn(i32) -> bool>>> =
                    ::std::cell::RefCell::new(::fnmock::fake_store::FakeStore::new("my_method"));
            }
        };
    ...
    fn test_generic_store() {
        ...
        let expected = quote! {
            thread_local! {
                static MY_METHOD_STORE: ::std::cell::RefCell<::fnmock::generic_fake_store::GenericFakeStore<2usize>> =
                    ::std::cell::RefCell::new(
                        ::fnmock::generic_fake_store::GenericFakeStore::new("my_method")
                    );
            }
        };
